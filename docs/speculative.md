...
- benchmark-positive results are narrow and currently centered on `Qwen3.5-9B q8_0`;
- broader dense speedups are on hold because the remaining gap looks structural rather than local.
...
| `mtp` | Use the model's native MTP / NextN head inside the main verifier context |
